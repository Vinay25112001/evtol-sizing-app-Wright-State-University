            ...
            <ScatterChart margin={{top:10,right:20,bottom:35,left:10}}>
              ...
              <Tooltip cursor={{strokeDasharray:"3 3"}} content={({payload})=>{
                ...
                return(<div style={{background:SC.panel,border:`1px solid ${SC.border}`,borderRadius:6,padding:"8px 12px",fontSize:9,fontFamily:"'DM Mono',monospace"}}>
                  {[["Range",d.range+" km"],["Payload",d.payload+" kg"],["MTOW",d.MTOW+" kg"],["Empty Wt",d.Wempty+" kg"],["Battery",d.Wbat+" kg"],["Energy",d.Etot+" kWh"],["Pack Cap",d.PackkWh+" kWh"],["L/D (act)",d.LDact],["L/D (input)",d.LD],["Hover Pwr",d.Phov+" kW"],["Cruise Pwr",d.Pcr+" kW"],["Bat Frac",d.batFrac+"%"],["Empty Frac",d.emptyFrac+"%"],["Wing Span",d.bWing+" m"],["Wing Area",d.Swing+" m²"],["Wing Load",d.WL+" N/m²"],["Static Margin",d.SM+"%"],["Tip Mach",d.TipMach],["RPM",d.RPM],["Cell SED",d.sedCell+" Wh/kg"],["Pack SED",d.SEDpack+" Wh/kg"],["AR",d.AR],["η_hov",d.etaHov],["η_sys",d.etaSys],["Status",d.feasible?"✅ Feasible":"❌ Infeasible"],["Pareto",d.pareto?"⭐ Yes":"—"]].map(([k,v])=>(
